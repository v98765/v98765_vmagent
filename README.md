...
---|---|---
`vmagent_version` |  1.68.0 | current version
...
`vmagent_remoteWrite_relabelConfig` |  | Optional path to file with relabel_config entries. These entries are applied to all the metrics before sending them to -remoteWrite.url. See [relabeling](https://victoriametrics.github.io/vmagent.html#relabeling) for details
`vmagent_remoteWrite_urlRelabelConfig` |  | 
...
cd /var/tmp/archive
wget https://github.com/VictoriaMetrics/VictoriaMetrics/releases/download/v1.68.0/vmutils-amd64-v1.68.0.tar.gz
```
