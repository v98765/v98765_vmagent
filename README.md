...
---|---|---
`vmagent_version` |  1.54.1 | current version
...
cd /var/tmp/archive
wget https://github.com/VictoriaMetrics/VictoriaMetrics/releases/download/v1.54.1/vmutils-amd64-v1.54.1.tar.gz
wget -O vmutils_checksums.txt https://github.com/VictoriaMetrics/VictoriaMetrics/releases/download/v1.54.1/vmutils-arm64-v1.54.1_checksums.txt
```
